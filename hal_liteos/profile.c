...
{
    static const bd_addr_t rand_addr = { 0xF3, 0xCC, 0x7D, 0x82, 0x7D, 0xC4 };
...
void ChenTaskEntry(void)
{
    ...
    if (osThreadNew((osThreadFunc_t)ChenTask, NULL, &attr) == NULL) {
        printf("[HelloDemo] Failed to create ChenTask!\n");
    }
}
